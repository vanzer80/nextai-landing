    ...
    <section className="pb-24 sm:pb-28">
      <Container>
        <div className="relative overflow-hidden rounded-3xl border border-primary/30 bg-primary px-6 py-16 text-center sm:px-12">
          ...
          <div aria-hidden className="pointer-events-none absolute -top-24 left-1/2 size-[28rem] -translate-x-1/2 rounded-full bg-white/10 blur-3xl" />
          <div className="relative mx-auto max-w-2xl">
            <h2 className="text-balance text-[1.9rem] font-bold leading-[1.1] text-on-primary sm:text-[2.6rem]">
            ...
            <p className="mx-auto mt-4 max-w-xl text-pretty text-lg text-on-primary/80">
              Sem apresentação genérica. Você mostra um caso real da sua operação e vê como ficaria no sistema.
            </p>
